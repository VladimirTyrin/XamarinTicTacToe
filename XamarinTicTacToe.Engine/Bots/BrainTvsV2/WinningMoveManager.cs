...
{
    internal class WinningMoveManager
    {
        public WinningMoveManager(FieldState state)
        {
            _width = state.Width;
        ...
        public Cell GetNextMove()
        {
            ...
            {
                LogMessage(LogLevel.Trace, "No winning move found");
            }
        ...
        private void LogMessage(LogLevel level, string message)
            => Logger.LogEntry("BTVSV2_WIN", level, message);
